...
libraryDependencies += "dev.zio" %% "zio-schema-bson"     % "0.0.6"
libraryDependencies += "dev.zio" %% "zio-schema-json"     % "0.0.6"
libraryDependencies += "dev.zio" %% "zio-schema-protobuf" % "0.0.6"

// Required for automatic generic derivation of schemas
libraryDependencies += "dev.zio" %% "zio-schema-derivation" % "0.0.6",
